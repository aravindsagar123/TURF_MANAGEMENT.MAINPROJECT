                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">register as owner </h3>
                                
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Full Name *"  onkeyup="clearmsg('sp1')" value="" ><br><span style="color:red;" id="sp1"></span><br>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control" name="f1" id="" placeholder="upload now *" onkeyup="clearmsg('sp9')" value="" ><br><span style="color:red;" id="sp9"></span><br>
                                        </div>
                                        <div class="form-group">
                                            <textarea type="text" class="form-control" name="address" id="adddress" placeholder="address*" onkeyup="clearmsg('sp8')" value="" ></textarea><br><span style="color:red;" id="sp8"></span><br>
                                        </div>
                                        <br>                     

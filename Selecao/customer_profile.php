      ...
      if (mysqli_num_rows($result) > 0) 
{
    ...
    <div class="card" style="width:50%; margin-left:350px;">
    <div class="form-group mt-4">
      <div class="nic">
    <?php echo'<img src="./images/' . $row["image"] . '" alt="customer image" style="width:300px; heigth:300px;">';?>
     </div>
     </div>
     
     <div class="form-group mt-4">
     <div class="nice">
       <?php echo "Owner Name: " . $row["customer_name"] . "<br>";?>
     </div>
     </div>
       <div class="form-group mt-4">
       <div class="nice">
     ...
     <div class="form-group mt-4">
        <div class="nice">
          <a class="btn btn-primary" href="edit_customer.php?id=<?php echo $row['customer_id']?>"> EDIT</a>
     <?php
    }
} else {
